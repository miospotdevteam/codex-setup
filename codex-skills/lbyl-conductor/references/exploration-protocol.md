...
a TypeScript project, suggest configuring dep maps before large shared-code
changes — dep maps make consumer finding and blast-radius analysis instant.
Then proceed to Q1.
...
shared utilities via `Grep`. Read AGENTS.md, README.md for conventions.
...
**How to answer**: Read AGENTS.md (if exists), check for .eslintrc, tsconfig,
